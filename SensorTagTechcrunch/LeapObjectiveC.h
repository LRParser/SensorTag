 ...
 * @available Since 1.0
 */
typedef NS_ENUM(NSInteger,LeapGestureType) {
...
typedef NS_ENUM(NSInteger,LeapGestureState) {
 ...
 *         deallocator:^void (void * bytes, NSUInteger length) {}];//No need to deallocate
 *
 * @since 2.1.5
 */
